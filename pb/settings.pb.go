...
var file_settings_proto_depIdxs = []int32{
	...
	11, // 31: pomerium.dashboard.Settings.mcp_allowed_client_id_domains:type_name -> pomerium.dashboard.Settings.StringList
	3,  // 32: pomerium.dashboard.Settings.blob_storage:type_name -> pomerium.dashboard.BlobStorageSettings
	1,  // 33: pomerium.dashboard.GetConsoleSettingsResponse.console_settings:type_name -> pomerium.dashboard.ConsoleSettings
	2,  // 34: pomerium.dashboard.GetSettingsResponse.settings:type_name -> pomerium.dashboard.Settings
	2,  // 35: pomerium.dashboard.SetSettingsRequest.settings:type_name -> pomerium.dashboard.Settings
	2,  // 36: pomerium.dashboard.SetSettingsResponse.settings:type_name -> pomerium.dashboard.Settings
	6,  // 37: pomerium.dashboard.SettingsService.GetSettings:input_type -> pomerium.dashboard.GetSettingsRequest
	8,  // 38: pomerium.dashboard.SettingsService.SetSettings:input_type -> pomerium.dashboard.SetSettingsRequest
	6,  // 39: pomerium.dashboard.SettingsService.GetBrandingSettings:input_type -> pomerium.dashboard.GetSettingsRequest
	4,  // 40: pomerium.dashboard.SettingsService.GetConsoleSettings:input_type -> pomerium.dashboard.GetConsoleSettingsRequest
	7,  // 41: pomerium.dashboard.SettingsService.GetSettings:output_type -> pomerium.dashboard.GetSettingsResponse
	9,  // 42: pomerium.dashboard.SettingsService.SetSettings:output_type -> pomerium.dashboard.SetSettingsResponse
	7,  // 43: pomerium.dashboard.SettingsService.GetBrandingSettings:output_type -> pomerium.dashboard.GetSettingsResponse
	5,  // 44: pomerium.dashboard.SettingsService.GetConsoleSettings:output_type -> pomerium.dashboard.GetConsoleSettingsResponse
