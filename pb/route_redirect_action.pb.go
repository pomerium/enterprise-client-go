...
const file_route_redirect_action_proto_rawDesc = "" +
	"\n" +
	"\x1broute_redirect_action.proto\x12\x12pomerium.dashboard\x1a\x17validate/validate.proto\"\xaf\x06\n" +
	...
	"\x0eprefix_rewrite\x18\x05 \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x02H\x01R\rprefixRewrite\x12a\n" +
	"\rregex_rewrite\x18\t \x01(\v2:.pomerium.dashboard.RedirectAction.RegexMatchAndSubstituteH\x01R\fregexRewrite\x12f\n" +
	"\rresponse_code\x18\x03 \x01(\x0e27.pomerium.dashboard.RedirectAction.RedirectResponseCodeB\b\xfaB\x05\x82\x01\x02\x10\x01R\fresponseCode\x12\x1f\n" +
	"\vstrip_query\x18\x06 \x01(\bR\n" +
	"stripQuery\x1am\n" +
	"\x17RegexMatchAndSubstitute\x12!\n" +
	"\apattern\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\apattern\x12/\n" +
	"\fsubstitution\x18\x02 \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x02R\fsubstitution\"w\n" +
...
var (
	...
	file_route_redirect_action_proto_rawDescData []byte
)

func file_route_redirect_action_proto_rawDescGZIP() []byte {
	file_route_redirect_action_proto_rawDescOnce.Do(func() {
		file_route_redirect_action_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_route_redirect_action_proto_rawDesc), len(file_route_redirect_action_proto_rawDesc)))
	})
...
func file_route_redirect_action_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_route_redirect_action_proto_rawDesc), len(file_route_redirect_action_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
