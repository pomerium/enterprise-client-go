...
func (RedirectAction_RedirectResponseCode) Descriptor() protoreflect.EnumDescriptor {
	return file_route_redirect_action_proto_enumTypes[0].Descriptor()
}

func (RedirectAction_RedirectResponseCode) Type() protoreflect.EnumType {
	return &file_route_redirect_action_proto_enumTypes[0]
}
...
func (RedirectAction_RedirectResponseCode) EnumDescriptor() ([]byte, []int) {
	return file_route_redirect_action_proto_rawDescGZIP(), []int{0, 0}
}
...
type RedirectAction struct {
	...
	ResponseCode RedirectAction_RedirectResponseCode `protobuf:"varint,3,opt,name=response_code,json=responseCode,proto3,enum=pomerium.dashboard.RedirectAction_RedirectResponseCode" json:"response_code,omitempty"`
...
func (x *RedirectAction) Reset() {
	*x = RedirectAction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_route_redirect_action_proto_msgTypes[0]
...
func (*RedirectAction) Descriptor() ([]byte, []int) {
	return file_route_redirect_action_proto_rawDescGZIP(), []int{0}
}
...
func (x *RedirectAction) GetRegexRewrite() *RedirectAction_RegexMatchAndSubstitute {
...
type RedirectAction_RegexMatchAndSubstitute struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RedirectAction_RegexMatchAndSubstitute) Reset() {
	*x = RedirectAction_RegexMatchAndSubstitute{}
	if protoimpl.UnsafeEnabled {
		mi := &file_route_redirect_action_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RedirectAction_RegexMatchAndSubstitute) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RedirectAction_RegexMatchAndSubstitute) ProtoMessage() {}

func (x *RedirectAction_RegexMatchAndSubstitute) ProtoReflect() protoreflect.Message {
	mi := &file_route_redirect_action_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RedirectAction_RegexMatchAndSubstitute.ProtoReflect.Descriptor instead.
func (*RedirectAction_RegexMatchAndSubstitute) Descriptor() ([]byte, []int) {
	return file_route_redirect_action_proto_rawDescGZIP(), []int{0, 0}
}

func (x *RedirectAction_RegexMatchAndSubstitute) GetPattern() string {
	if x != nil {
		return x.Pattern
	}
	return ""
...
func (x *RedirectAction_RegexMatchAndSubstitute) GetSubstitution() string {
	if x != nil {
...
var File_route_redirect_action_proto protoreflect.FileDescriptor

var file_route_redirect_action_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x5f, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74,
	0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x70,
	0x6f, 0x6d, 0x65, 0x72, 0x69, 0x75, 0x6d, 0x2e, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x1a, 0x17, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x2f, 0x76, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb0, 0x06, 0x0a, 0x0e, 0x52,
	...
	0x63, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x0b, 0xfa, 0x42, 0x08, 0x72, 0x06, 0xc8,
	0x01, 0x00, 0xc0, 0x01, 0x02, 0x52, 0x0c, 0x68, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x64, 0x69, 0x72,
	...
	0x0b, 0xfa, 0x42, 0x08, 0x72, 0x06, 0xc8, 0x01, 0x00, 0xc0, 0x01, 0x02, 0x48, 0x01, 0x52, 0x0c,
	...
	0x02, 0x48, 0x01, 0x52, 0x0d, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x52, 0x65, 0x77, 0x72, 0x69,
	0x74, 0x65, 0x12, 0x61, 0x0a, 0x0d, 0x72, 0x65, 0x67, 0x65, 0x78, 0x5f, 0x72, 0x65, 0x77, 0x72,
	0x69, 0x74, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3a, 0x2e, 0x70, 0x6f, 0x6d, 0x65,
	...
	0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x37, 0x2e, 0x70,
	0x6f, 0x6d, 0x65, 0x72, 0x69, 0x75, 0x6d, 0x2e, 0x64, 0x61, 0x73, 0x68, 0x62, 0x6f, 0x61, 0x72,
	0x64, 0x2e, 0x52, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x28, 0x08, 0x52, 0x0a, 0x73, 0x74, 0x72, 0x69, 0x70, 0x51, 0x75, 0x65, 0x72, 0x79, 0x1a, 0x6e,
	0x0a, 0x17, 0x52, 0x65, 0x67, 0x65, 0x78, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x41, 0x6e, 0x64, 0x53,
	0x75, 0x62, 0x73, 0x74, 0x69, 0x74, 0x75, 0x74, 0x65, 0x12, 0x22, 0x0a, 0x07, 0x70, 0x61, 0x74,
	0x74, 0x65, 0x72, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x8a,
	0x01, 0x02, 0x10, 0x01, 0x52, 0x07, 0x70, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x12, 0x2f, 0x0a,
	...
	0x52, 0x0c, 0x73, 0x75, 0x62, 0x73, 0x74, 0x69, 0x74, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x77,
	...
	0x69, 0x74, 0x65, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x42, 0x2d, 0x5a,
...
var (
	file_route_redirect_action_proto_rawDescOnce sync.Once
	file_route_redirect_action_proto_rawDescData = file_route_redirect_action_proto_rawDesc
)

func file_route_redirect_action_proto_rawDescGZIP() []byte {
	file_route_redirect_action_proto_rawDescOnce.Do(func() {
		file_route_redirect_action_proto_rawDescData = protoimpl.X.CompressGZIP(file_route_redirect_action_proto_rawDescData)
	})
	return file_route_redirect_action_proto_rawDescData
}

var file_route_redirect_action_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_route_redirect_action_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_route_redirect_action_proto_goTypes = []any{
	(RedirectAction_RedirectResponseCode)(0),       // 0: pomerium.dashboard.RedirectAction.RedirectResponseCode
	(*RedirectAction)(nil),                         // 1: pomerium.dashboard.RedirectAction
	(*RedirectAction_RegexMatchAndSubstitute)(nil), // 2: pomerium.dashboard.RedirectAction.RegexMatchAndSubstitute
}
var file_route_redirect_action_proto_depIdxs = []int32{
	2, // 0: pomerium.dashboard.RedirectAction.regex_rewrite:type_name -> pomerium.dashboard.RedirectAction.RegexMatchAndSubstitute
	0, // 1: pomerium.dashboard.RedirectAction.response_code:type_name -> pomerium.dashboard.RedirectAction.RedirectResponseCode
...
func init() { file_route_redirect_action_proto_init() }
func file_route_redirect_action_proto_init() {
	if File_route_redirect_action_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_route_redirect_action_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_route_redirect_action_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*RedirectAction_RegexMatchAndSubstitute); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_route_redirect_action_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_route_redirect_action_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_route_redirect_action_proto_goTypes,
		DependencyIndexes: file_route_redirect_action_proto_depIdxs,
		EnumInfos:         file_route_redirect_action_proto_enumTypes,
		MessageInfos:      file_route_redirect_action_proto_msgTypes,
	}.Build()
	File_route_redirect_action_proto = out.File
	file_route_redirect_action_proto_rawDesc = nil
	file_route_redirect_action_proto_goTypes = nil
	file_route_redirect_action_proto_depIdxs = nil
}
