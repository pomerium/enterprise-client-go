...
func file_namespaces_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_namespaces_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
		...
		file_namespaces_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
		...
		file_namespaces_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
